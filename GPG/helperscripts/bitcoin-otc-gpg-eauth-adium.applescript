...
# This works under OSX 10.6.8-10.15.8, Adium 1.5.*, MacGPG2 2.0.*
# In Adium, you need to set your IRC account options to run at least this command on connect: /join #bitcoin-otc
